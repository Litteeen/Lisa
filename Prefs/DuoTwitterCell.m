...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier specifier:(PSSpecifier *)specifier 
{
	...
	if (self) {
		...
		UIImage *avatarImageOne = [UIImage imageNamed:[NSString stringWithFormat:@"/Library/PreferenceBundles/LisaPrefs.bundle/%@.png", specifier.properties[@"firstAccount"]]];
		UIImage *avatarImageTwo = [UIImage imageNamed:[NSString stringWithFormat:@"/Library/PreferenceBundles/LisaPrefs.bundle/%@.png", specifier.properties[@"secondAccount"]]];
